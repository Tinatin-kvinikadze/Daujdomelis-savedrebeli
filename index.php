...
<a href="itire.html" class="fsalmuni">იტირე სულო</a>
  ...
  <article class="daujdomlis-gogoebi">
    ...
    <strong>ხათუნა(თამარ) </strong>თიგიშვილი<br>
...
$quotes = [
  [
    'author' => 'წმ. ეპისკოპოსი გაბრიელი(ქიქოძე)',
    'text' => 'თუ განსაცდელი გეწვია, ღმერთს მადლობა შესწირე,
     მოითმინე და თავი დაიმდაბლე.',

  ],
  [
    
    'author' => 'არქიმანდრიტი რაფაელი',
    'text' => 'ლოცვა არის მხსნელი კაცისა ყოველი განსაცდელისა 
    და უბედურებისაგან, ლოცვა შრეტს
     ღვთის რისხვას და მის მადლს ჰფენს სოფელს. 
     ამიტომაცაა ლოცვა ღვთის წყალობა კაცთა მიმართ.',

  ],
  [
    'author' => 'წმ. იოანე სინელი(კიბისაღმწერელი)',
    'text' => 'სული მაშინ ილოცებს მხურვალედ, როდესაც მრისხანებას დაძლევს',

  ],
  [
    'author' => 'წმ. ეპისკოპოსი გაბრიელი(ქიქოძე)',
    'text' => 'ვინც იგრძნო ტკბილი გემო ლოცვისა, 
    ცხოვრების სიმძიმეს ადვილად იტვირთავს',

  ],
  [
    'author' => 'წმ. სერაფიმე საროველი',
    'text' => 'მოიპოვე სულიერი სიმშვიდე და შენს გარშემო სხვებიც გადარჩებიან.',

  ],
  [
    'author' => 'ბერი პაისი ათონელი',
    'text' => 'ყველა ადამიანი ღებულობს ღვთისაგან უხვ კურთხევას, მაგრამ ცოტანი ემადლიერებიან მას,
     ცოტანი გრძნობენ კმაყოფილებას და სიხარულს ქრისტეს გვერდით.',
...
<blockquote>
  <h2 class="text">&ldquo;<?php echo $quoteText; ?>&ldquo;</h2>
  <strong class="author"> - <?php echo $quoteAuthor; ?></strong>
</blockquote>
